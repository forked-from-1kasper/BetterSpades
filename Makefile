...
ifeq ($(OS),Windows_NT)
    LDFLAGS = -static-libgcc -static-libstdc++ -lopenal -Wl,-Bstatic -lcglm -lenet -ldeflate -lglfw3 -lglew32 -lpthread -Wl,-Bdynamic -lopengl32 -lglu32 -lgdi32 -lwinmm -lws2_32
else
    UNAME := $(shell uname -s)
